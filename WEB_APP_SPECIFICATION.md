# Session Proof Web Guest Access - Technical Specification

**Version:** 1.0
**Date:** June 2026
**Purpose:** Comprehensive specification for building a web companion app for Session Proof iOS app
...
Session Proof is an iOS music collaboration app where producers upload mixes and get feedback from reviewers. This web app will allow **guest users** to access specific mixes via shareable codes to:
